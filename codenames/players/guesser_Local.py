...
class Guesser_local(Guesser):
    ...
    def __init__(self, team="Red"):
        ...
        self.num = 0
        self.guesses = 0
        system_prompt = game_rules + "You are playing the game Codenames as an expert player of the " + team + " Guesser. "
        self.manager = Ollama_local(system_prompt=system_prompt, version="gemma4:e4b")
